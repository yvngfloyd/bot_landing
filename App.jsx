          ...
          <section className="hero" id="hero">
            <div className="container hero-grid">
              <div className="hero-copy">
                ...
                <h1>
                  Разрабатываю ботов для бизнеса с записью, которые принимают обращения,
                  отвечают на частые вопросы и передают структурированные заявки в работу
                  через MAX, Telegram и при необходимости WhatsApp
                </h1>
