          ...
          <div className="container hero-grid">
            ...
            <div className="hero-visual">
              <div className="hero-card">
                ...
                <p>
                  Принимает сообщение, уточняет запрос, отвечает на типовые вопросы и передаёт в работу
                  уже структурированное обращение.
                </p>
        ...
        <section className="section section-dark" id="solutions">
          <div className="container">
            <div className="section-head section-head-dark">
              ...
              <p>Логика адаптируется под нишу, тип обращения, каналы связи и этапы обработки заявки.</p>
            </div>
