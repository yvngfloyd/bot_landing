          ...
          <div className="container hero-grid">
            <div className="hero-left">
              ...
              <p className="hero-text">
                Без лишней воды. Только полезные функции: запись клиентов, первичный отбор,
          ...
          <div className="container">
            <div className="contact-box">
              <div className="contact-left">
                ...
                <p>
                  Опишите коротко вашу задачу и мы составим подходящую
                  логику бота и предложим формат под ваш бизнес
                </p>
                <p>
                  Telegram: @tgbotsetup
                  <br />
                  WhatsApp: +7 908 167-31-09
                </p>
              </div>
