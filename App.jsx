    ...
    <>
      <header className="header">
        <div className="container header-inner">
          ...
          <a className="header-cta" href="https://wa.me/79081673109" target="_blank" rel="noreferrer">
            Получить схему
          </a>
        </div>
      </header>
          ...
          <div className="container hero-grid">
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                <a className="btn btn-primary" href="https://wa.me/79081673109" target="_blank" rel="noreferrer">
                  Получить схему
                </a>
        ...
        <section className="section section-muted" id="pain">
          <div className="container">
            <div className="section-head">
              ...
              <p>
                Когда обращения приходят вручную, администратор отвечает не сразу, срочные случаи не выделяются,
                а часть заявок теряется в переписке. В итоге бизнес теряет и время, и часть клиентов
              </p>
            </div>
        ...
        <section className="section section-muted" id="platforms">
          <div className="container">
            <div className="section-head">
              ...
              <p>
                Основные сценарии сейчас можно запускать в MAX и Telegram. Это позволяет выбрать привычный
                канал для клиента и не зависеть только от одной платформы. Если нужен дополнительный канал,
                можно отдельно рассмотреть и WhatsApp
              </p>
            </div>
        ...
        <section className="section section-dark" id="case">
          <div className="container">
            <div className="section-head section-head-dark">
              ...
              <p>
                На базе этого сценария можно собрать рабочее решение для клиники или локального бизнеса с записью
              </p>
            </div>
        ...
        <section className="section" id="process">
          <div className="container">
            <div className="section-head">
              ...
              <p>Для локального бизнеса важна не только автоматизация, но и простой путь от идеи до рабочего решения</p>
            </div>
          ...
          <div className="container">
            <div className="contact-card">
              <div className="contact-copy">
                ...
                <p>
                  Напишите, как сейчас к вам приходят обращения и где удобнее принимать заявки:
                  в MAX, Telegram или в нескольких каналах
                </p>
              </div>

              <div className="contact-actions">
                <a className="btn btn-primary" href="https://t.me/yevgeniyf1oyd" target="_blank" rel="noreferrer">
                  Написать в Telegram
                </a>

                <a className="btn btn-secondary" href="https://wa.me/79081673109" target="_blank" rel="noreferrer">
                  Написать в WhatsApp
                </a>
