...
const content = {
  ru: {
    ...
    pricingTitle: "Выберите подходящий формат под вашу задачу",
    pricingSubtitle:
      "Ниже представлены ориентиры по стоимости, составу работ и уровню сложности",
    ...
    pricingFinalBtn2: "Вернуться на сайт",
