            ...
            <div className="container hero-grid">
              <div className="hero-copy">
                <div className="eyebrow">
                    MAX, Telegram и WhatsApp под задачу бизнеса
                  </div>
                  ...
                  <p className="hero-text">
                    Приём заявок, ответы на частые вопросы, срочные обращения и передача
  структурированных заявок в работу через MAX, Telegram и при необходимости WhatsApp
                  </p>
